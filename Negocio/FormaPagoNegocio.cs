...
namespace Negocio
{
    public class FormaPagoNegocio
    {
        public List<FormaPago> listar()
        {
            ...
            try
            {
                datos.setConsultaSP("SP_ListarFormasPago");
                ...
                while (datos.Lector.Read())
                {
                    ...
                    if (!(datos.Lector["IDFormaPago"] is DBNull))
                        aux.ID = (byte)datos.Lector["IDFormaPago"];
        ...
        public void agregarFormaPago(FormaPago formaPago)
        {
            ...
            try
            {
                datos.setConsultaSP("SP_AgregarFormaPago");
                datos.setParametros("@nombre", formaPago.Nombre);
        ...
        public void modificarFormaPago(FormaPago formaPago)
        {
            ...
            try
            {
                datos.setConsultaSP("SP_ModificarFormaPago");
                datos.setParametros("@idFormaPago", formaPago.ID);
                datos.setParametros("@nombre", formaPago.Nombre);
                datos.ejecutarAccion();
            }
            catch (Exception ex)
        ...
        public void eliminarFormaPago(byte idFormaPago)
        {
            AccesoDatos datos = new AccesoDatos();
            try
            {
                datos.setConsultaSP("SP_EliminarFormaPago");
                datos.setParametros("@idFormaPago", idFormaPago);
                datos.ejecutarAccion();
            }
            catch (Exception ex)
            {
