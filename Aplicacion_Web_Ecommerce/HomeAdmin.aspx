  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <asp:Label ID="LabelIDMarca" runat="server" Text="ID de la marca"></asp:Label>
          <asp:TextBox ID="TxtIDMarca" runat="server"></asp:TextBox>
          <asp:Table ID="Table1" runat="server"></asp:Table>
          <asp:Label ID="LabelIDCategoria" runat="server" Text="IDCategiria"></asp:Label>
          <asp:TextBox ID="TxtIDCategoria" runat="server"></asp:TextBox>
          <asp:Table ID="Table2" runat="server"></asp:Table>
          <asp:Label ID="LabelIDGenero" runat="server" Text="IDGenero"></asp:Label>
          <asp:TextBox ID="TxtIDGenero" runat="server"></asp:TextBox>
          <asp:Table ID="Table3" runat="server"></asp:Table>
          <asp:Label ID="LabelIDTalla" runat="server" Text="IDTalla"></asp:Label>
          <asp:TextBox ID="TxtIDTalla" runat="server"></asp:TextBox>
          <asp:Table ID="Table4" runat="server"></asp:Table>
          <asp:Label ID="LabelNombreArticulo" runat="server" Text="Nombre del articulo"></asp:Label>
          <asp:TextBox ID="TxtNombreArticulo" runat="server"></asp:TextBox>
          <asp:Table ID="Table5" runat="server"></asp:Table>
          <asp:Label ID="LabelDescripcionArticulo" runat="server" Text="Descripcion"></asp:Label>
          <asp:TextBox ID="TxtDescripcionArticulo" runat="server"></asp:TextBox>
          <asp:Table ID="Table6" runat="server"></asp:Table>
          <asp:Label ID="LabelPrecio" runat="server" Text="Precio"></asp:Label>
          <asp:TextBox ID="TxtPrecio" runat="server"></asp:TextBox>
          <asp:Table ID="Table7" runat="server"></asp:Table>
          <asp:Label ID="LabelStock" runat="server" Text="Stock"></asp:Label>
          <asp:TextBox ID="TxtStock" runat="server"></asp:TextBox>
          <asp:Table ID="Table8" runat="server"></asp:Table>


      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
          <asp:Button ID="BtnEntendido" class="btn btn-primary" Onclick="Entendido_Click" runat="server" Text="Understood" />
      </div>
    </div>
  </div>
</div>
